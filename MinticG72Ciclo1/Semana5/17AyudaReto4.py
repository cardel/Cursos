...
def ordenes(rutinaContable):
    ...
    for orden in rutinaContable:
        ...
        pesos = reduce(lambda x,acc: 0 ,ventas) #x viene siendo una tupla por ejemplo ("5464", 4, 25842.99)
        ...
        if pesos < 600000:
            pesos += 25000
        print(f"La factura {factura} tiene un total en pesos de {round(pesos,2)}")
