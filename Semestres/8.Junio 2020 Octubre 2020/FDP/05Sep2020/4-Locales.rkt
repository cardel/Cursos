...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname 4-Locales) (read-case-sensitive #t) (teachpacks ((lib "guess.rkt" "teachpack" "htdp") (lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "guess.rkt" "teachpack" "htdp") (lib "draw.rkt" "teachpack" "htdp")) #f)))
;;Usando locales
...
(define (ordenarAux elemento lstOrdenada)
  (cond
    ...
    [else
     (local
       (
        (define primero (first lstOrdenada))
        (define resto  (rest lstOrdenada))
        )
       (cond
         [(string<? (email-remitente elemento) (email-remitente primero)) (cons elemento lstOrdenada)]
         [else (cons primero (ordenarAux elemento resto))]
         )
       )
     ]
    )
