...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 3-ProblemaEstructurasVersionC) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp") (lib "guess.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.rkt" "teachpack" "htdp") (lib "guess.rkt" "teachpack" "htdp")) #f)))
...
;;Contrato: incremento-por-color-aux: simbolo, numero -> numero
(define (incremento-por-color-aux color precio)
    (cond
     [(equal? color 'azul) (* 1.1 precio)]
     [(equal? color 'rojo) (* 1.2 precio)]
     [(equal? color 'gris) (* 1.15 precio)]
     [(equal? color 'blanco) (* 1.05 precio)]
     [(equal? color 'verde) (* 1.25 precio)]
     [(equal? color 'dorado) (* 1.75 precio)]
     [else (* 1.4 precio)]
     )
  )
...
(define (incremento-por-color comp)
  (make-computador
   ...
   (incremento-por-color-aux (computador-color comp) (computador-precio comp))
